...
opts_AddOptional '--mcsigma' 'CorrectionSigma' 'number' "myelin map bias correction sigma, this option is probably only intended for non-human-adult data, defaults to '$defaultSigma'" "$defaultSigma"
