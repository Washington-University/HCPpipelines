...
opts_SetScriptDescription "regresses group ICA spatial maps into individual data in order to obtain individual spatial maps of where the subject's similar function is"
