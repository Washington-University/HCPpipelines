...
if [[ "$SPECIES" =~ Human ]] ; then
	...
	T2wTemplateBrain="${HCPPIPEDIR_Templates}/MNI152_T2_0.7mm_brain" 
	...
	LowResMeshes="59@32" #Needs to match what is in PostFreeSurfer
	...
	T1wTemplate="${HCPPIPEDIR_Templates}/ChimpYerkes29_T1w_0.8mm.nii.gz"  
	T1wTemplateBrain="${HCPPIPEDIR_Templates}/ChimpYerkes29_T1w_0.8mm_brain.nii.gz" 
	...
	T2wTemplate="${HCPPIPEDIR_Templates}/ChimpYerkes29_T2w_0.8mm.nii.gz"  
	T2wTemplate2mmBrain="${HCPPIPEDIR_Templates}/ChimpYerkes29_T2w_1.6mm_brain.nii.gz" 
	T2wTemplateBrain="${HCPPIPEDIR_Templates}/ChimpYerkes29_T2w_0.8mm_brain.nii.gz" 
	...
	T1wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore.nii.gz" 
	T1wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_brain.nii.gz" 
	T1wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_1.0mm.nii.gz" 
	T1wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_1.0mm_brain.nii.gz" 
	T2wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore.nii.gz" 
	T2wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_brain.nii.gz" 
	T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_1.0mm.nii.gz" 
	T2wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_1.0mm_brain.nii.gz" 
	TemplateMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_brain_mask.nii.gz" 
	Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_1.0mm_brain_mask.nii.gz"
	...
	T2wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore.nii.gz"
	T2wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_brain.nii.gz"
	T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_1.0mm.nii.gz"
	T2wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_1.0mm_brain.nii.gz"
	TemplateMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_brain_mask.nii.gz"
	Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_1.0mm_brain_mask.nii.gz"
	SurfaceAtlasDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases"
	GrayordinatesSpaceDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases"
	...
	Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_1.0mm_brain_mask.nii.gz"
		...
		if [ "$SurfaceAtlas" = Yerkes19 ] ; then
			# Yerkes 19 sulc init
			SurfaceAtlasDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases_init"
			GrayordinatesSpaceDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases_init" # Yerkes 19
			ReferenceMyelinMaps="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases_init/MacaqueRIKEN16.Parial.MyelinMap_GroupCorr.164k_fs_LR.dscalar.nii"
		else
			# Mac30BS
			SurfaceAtlasDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases"  # Mac30BS
			GrayordinatesSpaceDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases"
			ReferenceMyelinMaps="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases/MacaqueRIKEN16.Parial.MyelinMap_GroupCorr.164k_fs_LR.dscalar.nii"
		fi
	...
	GrayordinatesResolution="1.25" #Needs to match what is in PostFreeSurfer. 
	InflateScale="1"
	...
	def_ciftiwisharts=2
	MION=${MION:-0}
	if [ $(hostname) != BCIL-G1 ] ; then
		TrainingData="NHPHCP_Macaque_RIKEN30MRFIX.RData"
		if [ "$MION" = 1 ] ; then 
			TrainingData=NHPHCP_Macaque.MION.RData
		fi
	else
		TrainingData="NHP_HCP_Macaque"
		if [ "$MION" = 1 ] ; then 
			TrainingData=/mnt/pub/PROJ/BICAN/Macaque/Winrich/Preprocessed3/TrainFix/TAZ.pyfix_model
		fi
	fi
	G_DEFAULT_LOW_RES_MESH=10

	# dMRI
	GrayordinatesResolutions="0.5@1.25" #Needs to match what is in PostFreeSurfer. 
	...
	T1wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore.nii.gz"
	T1wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_brain.nii.gz" 
	T1wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_0.5mm.nii.gz" 
	T1wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_0.5mm_brain.nii.gz" 
	T2wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore.nii.gz" 
	T2wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_brain.nii.gz"
	T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_0.5mm.nii.gz"
	T2wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_0.5mm_brain.nii.gz"
	TemplateMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_brain_mask.nii.gz"
	Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_0.5mm_brain_mask_dilM.nii.gz"
	...
	def_volwisharts=1
	def_ciftiwisharts=2
	TrainingData="NHPHCP_Marmoset.RData"
	...
	T1wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_0.25mm.nii.gz"
	T1wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_0.25mm_brain.nii.gz"
	T1wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_0.5mm.nii.gz"
	T2wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_0.25mm.nii.gz"
	T2wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_0.25mm_brain.nii.gz"
	T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT2w_restore_0.5mm.nii.gz"
	TemplateMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_0.25mm_brain_mask.nii.gz"
	Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/MNINonLinear/${BrainTemplate}_AverageT1w_restore_0.5mm_brain_mask.nii.gz"
