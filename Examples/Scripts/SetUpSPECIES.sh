...
if [[ "$SPECIES" == *Human* ]] ; then
    ...
    T1wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_${StrucRes}mm.nii.gz"  
    T1wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_${StrucRes}mm_brain.nii.gz" 
    T1wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_1.6mm.nii.gz"  
    T1wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_1.6mm_brain.nii.gz" 
    T2wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_${StrucRes}mm.nii.gz"  
    T2wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_1.6mm_brain.nii.gz" 
    T2wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_${StrucRes}mm_brain.nii.gz" 
    T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_1.6mm.nii.gz" 
    TemplateMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_${StrucRes}mm_brain_mask.nii.gz" 
    Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_1.6mm_brain_mask.nii.gz" 
    ...
    if [[ "$SPECIES" == *Mac30BS* ]] ; then     # Rhesus and Cyno hybrid template
        ...
        T1wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_${StrucRes}mm.nii.gz" 
        T1wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_${StrucRes}mm_brain.nii.gz" 
        T1wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_1.0mm.nii.gz" 
        T1wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_1.0mm_brain.nii.gz" 
        T2wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_${StrucRes}mm.nii.gz" 
        T2wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_${StrucRes}mm_brain.nii.gz" 
        T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_1.0mm.nii.gz" 
        T2wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_1.0mm_brain.nii.gz" 
        TemplateMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_${StrucRes}mm_brain_mask.nii.gz" 
        Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_1.0mm_brain_mask.nii.gz"
        SurfaceAtlasDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases"
        GrayordinatesSpaceDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases"
        ...
        T1wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_1.0mm.nii.gz"
        T1wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_1.0mm_brain.nii.gz"
        T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_1.0mm.nii.gz"
        T2wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_1.0mm_brain.nii.gz"
        Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_1.0mm_brain_mask.nii.gz"
        SurfaceAtlasDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases"
        GrayordinatesSpaceDIR="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/standard_mesh_atlases"
    ...
    T1wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_0.4mm.nii.gz" 
    T1wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_0.4mm_brain.nii.gz" 
    T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_0.4mm.nii.gz"
    T2wTemplate2mmBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_0.4mm_brain.nii.gz"
    Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_0.4mm_brain_mask_dilM.nii.gz"
    ...
    T1wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_${StrucRes}mm.nii.gz"
    T1wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_${StrucRes}mm_brain.nii.gz"
    T1wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_0.5mm.nii.gz"
    T2wTemplate="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_${StrucRes}mm.nii.gz"
    T2wTemplateBrain="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_${StrucRes}mm_brain.nii.gz"
    T2wTemplate2mm="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T2w_restore_0.5mm.nii.gz"
    TemplateMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_${StrucRes}mm_brain_mask.nii.gz"
    Template2mmMask="${HCPPIPEDIR_Templates}/NHP_NNP/${BrainTemplate}/${standardDir}/${BrainTemplate}_T1w_restore_0.5mm_brain_mask.nii.gz"
