...
export HCPPIPEDIR=/media/myelin/brainmappers/Connectome_Project/MishaLongitudinal/src/HCPpipelines-longitudinal_fs
...
export PATH="$HCPPIPEDIR/FreeSurfer/custom:$CARET7DIR:$FSLDIR/bin:$PATH"
