...
# this is an example script to run the tICA pipeline to clean a batch of subjects with group sICA and group tICA results that are both generated from a precomputation
# beginning from the first step 'MIGP' to the last step 'CleanData', even if the 'MIGP' is skipped under this mode
