...
get_batch_options() {
    ...
    unset command_line_specified_no_T2w
    ...
    while [ ${index} -lt ${numArgs} ]; do
        ...
        case ${argument} in
            ...
            --runlocal)
                ...
                ;;
            --noT2w)
                command_line_specified_no_T2w="TRUE"
                index=$(( index + 1 ))
                ;;
	    *)
		echo ""
...
UseT2w="TRUE"
if [[ ${command_line_specified_no_T2w} = "TRUE" ]] ; then
    echo "Reqested to run without T2w images."
    UseT2w="FALSE"
fi
