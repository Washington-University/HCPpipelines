...
do
    ...
    ln -s "$StudyFolder"/"$Subject"/"$fMRIName"/DistortionCorrectionAndEPIToT1wReg_FLIRTBBRAndFreeSurferBBRbased/FieldMap/PhaseOne_gdc_dc_jac.nii.gz "$WorkingDIR"/"$fMRIName"_PhaseOne_gdc_dc_jac.nii.gz
    ln -s "$StudyFolder"/"$Subject"/"$fMRIName"/DistortionCorrectionAndEPIToT1wReg_FLIRTBBRAndFreeSurferBBRbased/FieldMap/PhaseTwo_gdc_dc_jac.nii.gz "$WorkingDIR"/"$fMRIName"_PhaseTwo_gdc_dc_jac.nii.gz
    
    #didn't have _gdc in the name, so add it
    ln -s "$StudyFolder"/"$Subject"/"$fMRIName"/DistortionCorrectionAndEPIToT1wReg_FLIRTBBRAndFreeSurferBBRbased/FieldMap/SBRef_dc_jac.nii.gz "$WorkingDIR"/"$fMRIName"_SBRef_gdc_dc_jac.nii.gz
done
