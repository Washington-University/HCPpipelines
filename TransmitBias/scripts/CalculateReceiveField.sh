...
opts_AddMandatory '--session' 'Session' 'session ID' "(e.g. 100610)"
...
#TODO: add longitudinal options. Rename subject to session. Special-case every bbregister call to re-use the same transform.
