...
wb_command -volume-to-surface-mapping "$T1wFolder"/rPseudoTransmitField_Norm."$transmitRes".nii.gz "$T1wDownSampleFolder"/"$Subject".L.midthickness_"$RegName"."$LowResMesh"k_fs_LR.surf.gii "$DownSampleFolder"/"$Subject".L.rPseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.func.gii -ribbon-constrained "$T1wDownSampleFolder"/"$Subject".L.white_"$RegName"."$LowResMesh"k_fs_LR.surf.gii "$T1wDownSampleFolder"/"$Subject".L.pial_"$RegName"."$LowResMesh"k_fs_LR.surf.gii -volume-roi "$T1wFolder"/ROIs/L_TransmitBias_ROI."$transmitRes".nii.gz
wb_command -volume-to-surface-mapping "$T1wFolder"/rPseudoTransmitField_Norm."$transmitRes".nii.gz "$T1wDownSampleFolder"/"$Subject".R.midthickness_"$RegName"."$LowResMesh"k_fs_LR.surf.gii "$DownSampleFolder"/"$Subject".R.rPseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.func.gii -ribbon-constrained "$T1wDownSampleFolder"/"$Subject".R.white_"$RegName"."$LowResMesh"k_fs_LR.surf.gii "$T1wDownSampleFolder"/"$Subject".R.pial_"$RegName"."$LowResMesh"k_fs_LR.surf.gii -volume-roi "$T1wFolder"/ROIs/R_TransmitBias_ROI."$transmitRes".nii.gz
wb_command -cifti-create-dense-scalar "$DownSampleFolder"/"$Subject".rPseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.dscalar.nii -left-metric "$DownSampleFolder"/"$Subject".L.rPseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.func.gii -roi-left "$DownSampleFolder"/"$Subject".L.atlasroi."$LowResMesh"k_fs_LR.shape.gii -right-metric "$DownSampleFolder"/"$Subject".R.rPseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.func.gii -roi-right "$DownSampleFolder"/"$Subject".R.atlasroi."$LowResMesh"k_fs_LR.shape.gii
wb_command -cifti-dilate "$DownSampleFolder"/"$Subject".rPseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.dscalar.nii COLUMN 10 10 "$DownSampleFolder"/"$Subject".rPseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.dscalar.nii -nearest -left-surface "$T1wDownSampleFolder"/"$Subject".L.midthickness_"$RegName"."$LowResMesh"k_fs_LR.surf.gii -right-surface "$T1wDownSampleFolder"/"$Subject".R.midthickness_"$RegName"."$LowResMesh"k_fs_LR.surf.gii

wb_command -cifti-math "myelin / (transmit * $Slope + (1 - $Slope))" "$DownSampleFolder"/"$Subject".MyelinMap_PseudoCorr_"$RegName"."$LowResMesh"k_fs_LR.dscalar.nii \
    -var myelin "$SubjectMyelin" \
    -var transmit "$DownSampleFolder"/"$Subject".rPseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.dscalar.nii

tempfiles_create TransmitBias_ptnorm_XXXXXX.dscalar.nii tempnorm

wb_command -cifti-math "(Var * (Var > $PseudoTransmitThreshold)) / $PseudoTransmitReferenceValue" "$tempnorm" -var Var "$DownSampleFolder"/"$Subject".PseudoTransmitField_Raw_"$RegName"."$LowResMesh"k_fs_LR.dscalar.nii
wb_command -cifti-dilate "$tempnorm" COLUMN 25 25 "$DownSampleFolder"/"$Subject".PseudoTransmitField_Norm_"$RegName"."$LowResMesh"k_fs_LR.dscalar.nii -nearest -left-surface "$T1wDownSampleFolder"/"$Subject".L.midthickness_"$RegName"."$LowResMesh"k_fs_LR.surf.gii -right-surface "$T1wDownSampleFolder"/"$Subject".R.midthickness_"$RegName"."$LowResMesh"k_fs_LR.surf.gii
