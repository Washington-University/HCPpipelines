function B1Tx_GroupAverage(IndCorrMyelinAvgFile, IndCorrMyelinAsymmOutFile, IndCorrAllMyelinFile, GoodVoltagesFile, SB1TxFile, B1TxStatsFile, CSFStatsFile, RegressedMyelinOutFile, CovariatesOutFile)
    AvgICorrMyelinMap = cifti_read(IndCorrMyelinAvgFile);
    ...
    %save regressors
    regressors = [GoodVoltages mean(SB1Tx.cdata)' FWHM(:, 3) FWHM(:, 2) FWHM(:, 1) CSFRegressors(:, maxind)];
