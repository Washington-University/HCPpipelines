...
# To detect this situation, and prevent it from occurring, FreeSurferPipeline errors out if the
# one-step warpfield created here ($OutputOrigT2wToT1w) already exists.]
