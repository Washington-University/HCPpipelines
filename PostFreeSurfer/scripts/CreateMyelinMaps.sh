...
SurfaceSmoothingFWHM="4"
 ...
 if [[ "$SPECIES" =~ "Macaque" ]] ; then
 	#MyelinMappingFWHM="3.9" # based on median cortical thickness of macaque
 	MyelinMappingFWHM="2" # based on median cortical thickness of macaque
 	SurfaceSmoothingFWHM="2" # 4 by default
 elif [[ "$SPECIES" =~ "Marmoset" ]] ; then
 	#MyelinMappingFWHM="3.1" # based on median cortical thickness of marmoset
  	#SurfaceSmoothingFWHM="1.6" # 4 by default
 	...
 	MyelinMappingFWHM="5" # 5 by default
