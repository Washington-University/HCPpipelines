...
case "$MatlabMode" in
    (0)
        matlab_cmd=("$this_script_dir/Compiled_RunPROFUMO/run_RunPROFUMO.sh" "$MATLAB_COMPILER_RUNTIME" "${matlab_argarray[@]}")
...
log_Msg "RunPROFUMO step completed successfully"