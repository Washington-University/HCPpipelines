...
opts_AddOptional '--use-t2w-phase-zero' 'UsePhaseZero' 'TRUE/FALSE' "Indicates whether to add T2-weighted image as a phase zero volume, for dark-CSF T2w contrast acquisition types (e.g., FLAIR)" "FALSE"
