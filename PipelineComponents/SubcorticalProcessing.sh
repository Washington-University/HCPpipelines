...
for Structure in $Structures ; do
  ...
  caret_command -volume-atlas-resampling-and-smoothing "$VolumefMRI".nii "$ROIFolder"/"$Structure"."$FinalfMRIResolution".nii.gz "$ROIFolder"/Atlas_"$Structure"."$FinalfMRIResolution".nii.gz "$WorkingDirectory"/temp.nii $Sigma
