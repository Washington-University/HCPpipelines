...
opts_AddMandatory '--fmri-name' 'fMRIName' 'string' "name of the fMRI run (e.g. rfMRI_REST1_LR)"
...
#parse booleans to 0/1 for MATLAB
...
log_Msg "fMRIStats processing complete"
