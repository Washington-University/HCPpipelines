...
DEFAULT_STUDY_FOLDER="/media/myelin/brainmappers/Connectome_Project/YA_HCP_Final" # location of Subject folders (named by subjectID)
...
DEFAULT_ENVIRONMENT_SCRIPT="/media/myelin/brainmappers/Connectome_Project/YA_HCP_Final/Scripts/SetUpHCPPipeline_AY.sh"
