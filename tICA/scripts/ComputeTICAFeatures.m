...
Stats=load([OutputFolder '/stats_' num2str(tICAdim) '_' nonlinear '.wb_annsub.csv'],'-ascii');
...
vertarearight = gifti([pipedir '/global/templates/standard_mesh_atlases/resample_fsaverage/fs_LR.R.midthickness_va_avg.' LowResMesh 'k_fs_LR.shape.gii']);
